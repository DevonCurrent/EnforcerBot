...
public class TestManageMembersCommands {
    ...
    public void testKickCommand() throws InterruptedException {
        User userToKick = botAccount.getUsersByName("User to ban name", true).get(0);
    ...
    //Will fail if testKickCommand runs beforehand.
    ...
    public void testInBanList() throws InterruptedException {
        User userToBan = botAccount.getUsersByName("User to ban name", true).get(0);
        ...
        while(banListIterator.hasNext()){
            ...
            if(bannedUserName.equals("User to ban name"))
